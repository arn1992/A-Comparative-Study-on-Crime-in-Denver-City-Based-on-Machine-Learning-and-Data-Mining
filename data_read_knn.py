...
print('KNeighborsClassifier accuracy : ',scores.mean())
...
print("KNeighborsClassifier accuracy for SelectKBest: ",a)
...
a=accuracy_score(y_pred,ytest)
print("KNeighborsClassifier accuracy for VarianceThreshold : ",a)
