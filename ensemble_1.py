...
eclf = VotingClassifier(estimators=[('DT', clf1), ('rf', clf2), ('lda', clf3)], voting='hard')

for clf, label in zip([clf1, clf2, clf3, eclf], ['Decision Tree', 'Random Forest', 'Linear Discriminant Analysis', 'Ensemble']):
