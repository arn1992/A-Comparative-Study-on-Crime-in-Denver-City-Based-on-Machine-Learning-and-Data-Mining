...
clf=ExtraTreesClassifier(n_estimators=50, max_depth=7,random_state=0).fit(X_train,y_train)
...
nb=ExtraTreesClassifier(n_estimators=50, max_depth=7,random_state=0)
...
pipeline = Pipeline([
                     ...
                     ('clf', ExtraTreesClassifier(n_estimators=50, max_depth=7,random_state=0))])
